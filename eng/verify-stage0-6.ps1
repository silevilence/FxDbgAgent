...
try {
    ...
    & (Join-Path $PSScriptRoot 'validation-dotnet.ps1') build 'tests/Probes/FxDbg.Breakpoint.Probe/FxDbg.Breakpoint.Probe.csproj' --configuration $Configuration --no-incremental
    if ($LASTEXITCODE -ne 0) {
